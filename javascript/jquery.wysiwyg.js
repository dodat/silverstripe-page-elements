...
(function( $ )
{
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            ...
            h6mozilla : { visible : true && $.browser.mozilla, className : 'h6', command : 'heading', arguments : ['h6'], tags : ['h6'] },
            ...
            h6 : { visible : true && !( $.browser.mozilla ), className : 'h6', command : 'formatBlock', arguments : ['Heading 6'], tags : ['h6'] },
            ...
            if ( this.options.css )
            {
                setTimeout(function()
                {
                    if ( self.options.css.constructor == String )
                    {
                        ...
                        $(self.editorDoc).find('head').append(
